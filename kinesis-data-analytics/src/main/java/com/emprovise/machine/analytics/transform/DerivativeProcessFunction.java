...
public class DerivativeProcessFunction extends KeyedProcessFunction<Tuple2<Long, Long>, MachineStat, MachineStat> {

    private static final Logger LOG = LoggerFactory.getLogger(DerivativeProcessFunction.class);
    ...
    @Override
    public void processElement(MachineStat machineStat, Context context, Collector<MachineStat> collector) throws Exception {
